...
const CompanyVision: FC = memo(() => (
  <div className="">
    <div className="container mx-auto flex flex-col xl:px-60">
      <div className="self-start m-5">
        ...
        <p className={`${styles.vision_text} text-3xl text-left ml-8 mr-2`}>
      ...
      <p className={`${styles.vision_text} text-3xl self-end text-right mr-14 ml-6`}>
