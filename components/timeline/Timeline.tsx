          ...
          <div className="relative container mx-auto px-6 flex flex-col">
            ...
            {TimelineDataJuli.map((timeline, id) => (
              <div key={id} className="relative z-10">
                <div className="h-8 w-8 md:h-16 md:w-16 xl:h-16 xl:w-16 object-cover mt-20 bg-blue-ceo rounded-full shadow-md border-4 border-yellow-ceo xs:absolute md:mx-auto md:left-0 md:right-0 flex items-center justify-center">
                  <span className="text-white-ceo text-lg font-bold relative z-10">{id + 1}</span>
                </div>
                <div
                  className={`${
                    id % 2 === 0
                      ? "relative md:w-1/2 md:ml-0 -mt-24 xs:pl-28 xs:pt-0 md:mr-auto md:pl-0 md:pr-16"
                      : "relative md:w-1/2 md:ml-auto xs:pl-28 xs:pt-0 md:pl-16 -mt-24"
                  }`}
                >
